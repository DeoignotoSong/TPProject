...
double CTraderHandler::choosePrice(CThostFtdcDepthMarketDataField* latestInfo, bool buyIn) {
	...
	case(SlipperyPhase::PHASE_3): {
		...
		price = buyIn ? (latestInfo->AskPrice1 + premium)
...
void CTraderHandler::OnRspQryDepthMarketData(CThostFtdcDepthMarketDataField* pDepthMarketData, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	...
	if (pDepthMarketData != nullptr) {
		os << "\ninstrumentId: " << pDepthMarketData->InstrumentID
			...
			<< "\nAskPrice: " << pDepthMarketData->AskPrice1
			<< "\nBidPrice: " << pDepthMarketData->BidPrice1
